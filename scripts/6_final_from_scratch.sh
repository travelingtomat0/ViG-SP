...
python -m torch.distributed.launch --nproc_per_node="$NUMWORKERS" ~/vig_pytorch/train_copy.py /scratch/tomap/imagenet-1k/ILSVRC/Data/CLS-LOC/ --model sp_vig --sched cosine --epochs 130 --cooldown-epochs 15 --segments 196 --compactness 10 --opt adamw -j "$NUMWORKERS" --num-classes 1000 --warmup-lr 1e-6 --mixup 0 --cutmix 0 --model-ema --model-ema-decay 0.99996 --aa rand-m9-mstd0.5-inc1 --color-jitter 0.4 --warmup-epochs 20 --opt-eps 1e-8 --repeated-aug --remode pixel --reprob 0.25 --amp --lr 6e-5 --weight-decay .05 --drop 0 --drop-path .1 -b 22 --output /itet-stor/tomap/superpixel_gnns/outputs/sp_model/
